    ...
    public class AdminMenu : INavigationProvider {
        ...
        public void GetNavigation(NavigationBuilder builder) {
            ...
            builder.Add(T("Settings"), menu => menu
                    .Add(T("Rewrite Rules"), "10", subMenu => subMenu.Action("Index", "Admin", new { area = "Settings", groupInfoId = "RewriteRules" }).Permission(StandardPermissions.SiteOwner)
                        .Add(T("Settings"), "10", item => item.Action("Index", "Admin", new { area = "Settings", groupInfoId = "RewriteRules" }).Permission(StandardPermissions.SiteOwner).LocalNav())
